@REM This curl sample demonstrates how to run an automated campaign using
...
curl --data-binary @RunCampaign.json -H "Content-Type: text/json" -H "Authorization: %API_AUTHORIZETOKEN%" %BASEURL%/campaignmanager/run.json