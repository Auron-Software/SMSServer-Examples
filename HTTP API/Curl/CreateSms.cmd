@REM This curl sample demonstrates how to send a new SMS message using
...
curl --data-binary @CreateSms.json -H "Content-Type: text/json" -H "Authorization: %API_AUTHORIZETOKEN%" %BASEURL%/messagedb/create.json