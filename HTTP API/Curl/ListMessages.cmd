@REM This curl sample demonstrates how to run list SMS messages using
...
curl --data-binary @ListMessages.json -H "Content-Type: text/json" -H "Authorization: %API_AUTHORIZETOKEN%" %BASEURL%/messagedb/load.json