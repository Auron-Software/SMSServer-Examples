@REM This curl sample demonstrates how get SMS Server version information using 
...
curl -H "Content-Type: text/json" -H "Authorization: %API_AUTHORIZETOKEN%" %BASEURL%/messagedb/version.json